...
![Release](https://img.shields.io/badge/Release-v1.2.3-green?style=flat-square)
...
This is an actively developed personal project. The CLI engine is currently complete and stable (`v1.2.3`). The web-based UI Next.js frontend is fully embedded and deployed!
